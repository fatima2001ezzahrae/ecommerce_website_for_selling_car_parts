...
<body class="home-page home-01 ">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+212) 000 666" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+212) 000 666</a>
								</li>
							</ul>
						</div>
                                ...
                                @if(Route::has('login'))
                                   @auth
                                        @if(Auth::user()->utype==='ADM')
                                            <li class="menu-item menu-item-has-children parent" >
                                                <a title="Acount" href="#">My Account({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency" >
                                                    <li class="menu-item" >
    ...
    <script src="https://cdn.tiny.cloud/1/oks5psg8dn1h9gu04npa4sqkrvv7yz1564zibahicqlqr6qw/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
