                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('admin.products') }}" class="btn btn-success pull-right">All Productss</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" enctype="multipart/fore-data" wire:submit.prevent="updateProduct">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" wire:model="category_id" wire:change="changeSubcategory">
                                        <option value="">Select storeCategory</option>
