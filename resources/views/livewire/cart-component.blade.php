                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            ...
                            <p class="text-center"><a href="#" wire:click.preventd="switchToSaveForLater('{{ $item->rowId }}')">Save For Later</a></p>
                        </div>
            ...
            <div class="wrap-iten-in-cart">
                ...
                <ul class="products-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="price-field produtc-price"><p class="price">${{ $item->model->regular_price }}</p></div>
                        <div class="quantity">
                            <p class="text-center"><a href="#" wire:click.preventd="moveToCart('{{ $item->rowId }}')">Move To Cart</a></p>
                        </div>
                        <div class="delete">
